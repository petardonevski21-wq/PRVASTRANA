document.addEventListener('DOMContentLoaded', () => {
 ...
 // ... претходниот код за скролање на хедерот ...
    ...
    // =========================================
    // --- ПРЕМЕСТУВАЊЕ ТУКА: SEARCH PANEL ЛОГИКА ---
    // =========================================
...
}); // ТУКА СЕ ЗАТВОРА ЦЕЛИОТ DOMContentLoaded ОД ПОЧЕТОКОТ НА ФАЈЛОТ
...
// =========================================
// --- СЛЕДЕЊЕ НА SWIPE И АЖУРИРАЊЕ НА КРУКЧИЊАТА ---
// =========================================
const productImagesContainer = document.querySelector('.product-images');
const dots = document.querySelectorAll('.dot');

if (productImagesContainer && dots.length > 0) {
    productImagesContainer.addEventListener('scroll', () => {
        const width = productImagesContainer.clientWidth;
        // Пресметува која слика е моментално на екранот
        const activeIndex = Math.round(productImagesContainer.scrollLeft / width);
